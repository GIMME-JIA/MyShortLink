...
import org.jia.mylink.project.dao.entity.LinkBrowserStatsDO;
...
public interface LinkBrowserStatsMapper extends BaseMapper<LinkBrowserStatsDO> {
    ...
    List<HashMap<String, Object>> listBrowserStatsByShortLink(@Param("param") LinkStatsReqDTO requestParam);
    ...
    @Select("SELECT " +
            ...
            "GROUP BY " +
            "    gid, browser;")
    List<HashMap<String, Object>> listBrowserStatsByGroup(@Param("param") LinkGroupStatsReqDTO requestParam);
}
